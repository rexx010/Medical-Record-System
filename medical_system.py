...
class MedicalSystem:
    ...
    def reschedule_appointment(self, patient_id: str, old_date: str, new_date: str):
        old_date: datetime = self.__validate_appointment_date(old_date)
        new_date: datetime = self.__validate_appointment_date(new_date)
        self.__check_future_date(new_date)
        ...
        for appointment in self.__appointments:
            if appointment.patient.get_id == patient_id and appointment.date == old_date:
                ...
                return f"Appointment for patient {appointment.patient.name} has been rescheduled to {new_date}"
